...
class Language
{
    ...
    public function __construct(string $language)
    {
        ...
        if ($this->language == "en-us") {
            ...
            $this->text["intro3"] = '<span style="font-size:16px;" class="text-presentation lh-lg"> - I have a passion for technology. With over 2 years of experience in the field and constantly seeking learning opportunities, my goal is to enter and excel in the technology market. I am eager to explore available opportunities!</span>';

            // Project Page
            $this->text["project_page_title1"] = "Personal Projects";
            $this->text["project_page_title2"] = "Real projects that I was part of developing.";
            ...
            $this->text["intro3"] = '<span style="font-size:16px;" class="text-presentation lh-lg"> - Tenho uma paixão pela tecnologia. Com mais de 2 anos de experiência na área e em busca constante de aprendizado, tenho o objetivo de ingressar e sobressair no mercado de tecnologia. Estou ansioso para explorar oportunidades disponíveis!</span>';

            // Página de Projetos
            $this->text["project_page_title1"] = "Projetos Próprios";
            $this->text["project_page_title2"] = "Projetos reais que fiz parte do desenvolvimento.";
